...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.98\linewidth]{plots/v1_vs_v2_comparison.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.98\linewidth]{plots/streamspot_roc_contrast.png}}
...
\textbf{Full Fusion (Ours)} & \textbf{0.9837} & \textbf{0.9784} & \textbf{0.9901} & \textbf{0.9628} & \textbf{0.6909} \\
\bottomrule
\end{tabular}}
\newline\vspace{1pt}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.98\linewidth]{plots/causal_feature_heatmap.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.98\linewidth]{plots/stacked_fusion_weights.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.98\linewidth]{plots/noise_sensitivity_analysis.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.98\linewidth]{plots/contamination_sweep.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.98\linewidth]{plots/drift_fpr_comparison.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.98\linewidth]{plots/threshold_adaptation_learning.png}}
