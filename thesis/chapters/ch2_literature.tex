...
\begin{enumerate}
\item \textbf{Zero-label causal IDS for provenance graphs}: No existing system combines causal
    mechanism violation detection with provenance-graph analysis without requiring labels or clean
    data.
